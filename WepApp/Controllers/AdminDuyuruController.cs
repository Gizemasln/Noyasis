...
{
    public class AdminDuyuruController : AdminBaseController
    {
        private readonly DuyuruRepository _repository;
        private readonly IWebHostEnvironment _hostEnvironment;

        public AdminDuyuruController(IWebHostEnvironment hostEnvironment)
        {
            _repository = new DuyuruRepository();
